...
public class TransactionOutput extends ChildMessage {
     ...
     */
    public TransactionOutput(NetworkParameters params, Transaction parent, byte[] payload, int offset, MessageSerializer serializer) throws ProtocolException {
     ...
     */
    public TransactionOutput(NetworkParameters params, Transaction parent, Coin value, Address to) {
     ...
     */
    public TransactionOutput(NetworkParameters params, Transaction parent, Coin value, ECKey to) {
        this(params, parent, value, ScriptBuilder.createOutputScript(to).getProgram());
    }

    public TransactionOutput(NetworkParameters params, Transaction parent, Coin value, byte[] scriptBytes) {
        super(params);
