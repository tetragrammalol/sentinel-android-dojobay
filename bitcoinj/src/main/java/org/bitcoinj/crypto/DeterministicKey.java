...
public class DeterministicKey extends ECKey {
    ...
    public DeterministicKey encrypt(KeyCrypter keyCrypter, KeyParameter aesKey, DeterministicKey newParent) throws KeyCrypterException {
     ...
     */
    @Override public KeyCrypter getKeyCrypter() {
        if (keyCrypter != null)
            return keyCrypter;
        else if (parent != null)
    ...
    /**
      ...
      */
    public static DeterministicKey deserializeB58(DeterministicKey parent, String base58, NetworkParameters params) {
     ...
     * @param parent The parent node in the given key's deterministic hierarchy.
     */
    public static DeterministicKey deserialize(NetworkParameters params, byte[] serializedKey, DeterministicKey parent) {
