...
public class MnemonicCode {
    ...
    public static final String SPARROW_FIX_NFKD_MNEMONIC = "com.sparrowwallet.fixNfkdMnemonic";
    ...
    public static byte[] toSeed(List<String> words, String passphrase) {
        ...
        if(System.getProperty(SPARROW_FIX_NFKD_MNEMONIC) != null) {
            // fix NFKD encoding for Sparrow
            salt = "mnemonic" + Normalizer.normalize(passphrase, Normalizer.Form.NFKD);
        }
